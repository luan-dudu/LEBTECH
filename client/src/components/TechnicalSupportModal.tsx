...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    setFormData({ name: '', email: '', phone: '', company: '', problemType: 'hardware', problemDescription: '', urgency: 'normal' });
    onClose();
  } catch (error: any) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-card border border-border rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label htmlFor="problemType" className="block text-sm font-semibold text-foreground">Tipo de Problema *</label>
            ...
            <div className="space-y-2">
              <label htmlFor="urgency" className="block text-sm font-semibold text-foreground">Nível de Urgência *</label>
          ...
          <div className="space-y-2">
            <label htmlFor="problemDescription" className="block text-sm font-semibold text-foreground">Descrição do Problema *</label>
            <textarea id="problemDescription" name="problemDescription" value={formData.problemDescription}
